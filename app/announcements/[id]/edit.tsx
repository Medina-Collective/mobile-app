          ...
          {selectedType === 'event' && (
            <View style={styles.section}>
              ...
              <Controller
                ...
                name="eventDate"
                render={({ field: { value, onChange } }) => (
                  <DatePicker label="Date" value={value} onChange={onChange} placeholder="Pick a date" />
                )}
              />
              <Controller
                control={control}
              ...
              <Controller
                ...
                name="location"
                render={({ field: { value, onChange } }) => (
                  <LocationAutocomplete label="Location" value={value} onChange={onChange} error={errors.location?.message} placeholder="Venue name or address" />
                )}
              />
              <Controller
                control={control}
                name="girlsOnly"
                render={({ field: { value, onChange } }) => (
                  <ToggleRow label="Girls Only" hint="Restrict to women only" value={value} onChange={onChange} />
                )}
              />
              <Controller
                control={control}
                name="isFree"
                render={({ field: { value, onChange } }) => (
                  <ToggleRow label="Free Event" hint="No cost to attend" value={value} onChange={onChange} />
                )}
              />
              {!isFree && (
                <Controller
                  ...
                  name="price"
                  render={({ field: { value, onChange, onBlur } }) => (
                    <Input label="Price" value={value} onChangeText={onChange} onBlur={onBlur} placeholder='e.g. $25' />
                  )}
                />
              )}
              <Controller
                ...
                render={({ field: { value, onChange, onBlur } }) => (
                  <Input label="Max Participants (optional)" value={value === undefined ? '' : String(value)} onChangeText={(t) => onChange(t.length > 0 ? Number.parseInt(t, 10) : undefined)} onBlur={onBlur} keyboardType="number-pad" placeholder="Leave empty for unlimited" />
                )}
              />
              <Controller
                control={control}
                ...
                render={({ field: { value, onChange, onBlur } }) => (
                  <Input label="Registration Link (optional)" value={value} onChangeText={onChange} onBlur={onBlur} placeholder="https://..." keyboardType="url" autoCapitalize="none" />
                )}
              />
            </View>
          )}
          ...
          {selectedType === 'offer' && (
            <View style={styles.section}>
              ...
              <Controller
                ...
                name="discountLabel"
                render={({ field: { value, onChange, onBlur } }) => (
                  <Input label="Discount Label" value={value} onChangeText={onChange} onBlur={onBlur} placeholder='"25% OFF", "Buy 1 Get 1"' />
                )}
              />
              <Controller
                control={control}
                name="validUntil"
                render={({ field: { value, onChange } }) => (
                  <DatePicker label="Valid Until" value={value} onChange={onChange} minimumDate={new Date()} placeholder="Pick an expiry date" />
                )}
              />
              <Controller
                control={control}
                name="promoCode"
                render={({ field: { value, onChange, onBlur } }) => (
                  <Input label="Promo Code (optional)" value={value} onChangeText={onChange} onBlur={onBlur} placeholder="e.g. SPRING25" autoCapitalize="characters" />
                )}
              />
              <Controller
                control={control}
                name="shopLink"
                render={({ field: { value, onChange, onBlur } }) => (
                  <Input label="Link to Shop (optional)" value={value} onChangeText={onChange} onBlur={onBlur} placeholder="https://..." keyboardType="url" autoCapitalize="none" />
                )}
              />
            </View>
          )}
          ...
          {selectedType === 'update' && (
            <View style={styles.section}>
              ...
              <Controller
                ...
                name="deadline"
                render={({ field: { value, onChange } }) => (
                  <DatePicker label="Deadline (optional)" value={value} onChange={onChange} minimumDate={new Date()} placeholder="Set a deadline" />
                )}
              />
              <Controller
                control={control}
                name="externalLink"
                render={({ field: { value, onChange, onBlur } }) => (
                  <Input label="External Link (optional)" value={value} onChangeText={onChange} onBlur={onBlur} placeholder="https://..." keyboardType="url" autoCapitalize="none" />
                )}
              />
            </View>
          )}
...
function CategoryPicker({
  ...
  return (
    <View style={cpStyles.wrapper}>
      ...
      <TouchableOpacity style={[cpStyles.trigger, hasError && cpStyles.triggerError]} onPress={() => setOpen(true)} activeOpacity={0.7}>
        <Text style={[cpStyles.triggerText, !value && cpStyles.placeholder]}>{value ?? 'Select a category'}</Text>
        ...
        <View style={cpStyles.overlay}>
          <View style={cpStyles.sheet}>
            ...
            <FlatList
              ...
              renderItem={({ item }) => (
                <TouchableOpacity style={[cpStyles.option, value === item && cpStyles.optionActive]} onPress={() => { onChange(item); setOpen(false); }} activeOpacity={0.7}>
                  <Text style={[cpStyles.optionText, value === item && cpStyles.optionTextActive]}>{item}</Text>
                  {value === item && <Ionicons name="checkmark" size={16} color={colors.burgundy.mid} />}
                </TouchableOpacity>
              )}
            />
          </View>
...
const cpStyles = StyleSheet.create({
  ...
  label: { fontSize: 10, fontWeight: '700', letterSpacing: 1.2, textTransform: 'uppercase', color: colors.warm.muted, marginBottom: spacing[2] },
  trigger: { flexDirection: 'row', alignItems: 'center', justifyContent: 'space-between', height: 44, borderRadius: 12, borderWidth: 1, borderColor: colors.warm.border, backgroundColor: colors.warm.surface, paddingHorizontal: spacing[3] },
  ...
  sheet: { backgroundColor: colors.neutral[0], borderTopLeftRadius: 20, borderTopRightRadius: 20, paddingBottom: spacing[8], maxHeight: '70%' },
  sheetHeader: { flexDirection: 'row', alignItems: 'center', justifyContent: 'space-between', padding: spacing[4], borderBottomWidth: 1, borderBottomColor: colors.warm.border },
  sheetTitle: { fontSize: 16, fontWeight: '600', color: colors.warm.title },
  option: { flexDirection: 'row', alignItems: 'center', justifyContent: 'space-between', paddingHorizontal: spacing[4], paddingVertical: spacing[3], borderBottomWidth: 1, borderBottomColor: colors.warm.border },
...
function ToggleRow({ label, hint, value, onChange }: Readonly<{ label: string; hint: string; value: boolean; onChange: (v: boolean) => void }>) {
  return (
    <View style={toggleStyles.row}>
      ...
      <Switch value={value} onValueChange={onChange} trackColor={{ false: '#78716c', true: colors.burgundy.mid }}
        ios_backgroundColor="#78716c" thumbColor={colors.warm.elevated} />
    </View>
  );
}
const toggleStyles = StyleSheet.create({
  row: { flexDirection: 'row', alignItems: 'center', justifyContent: 'space-between', backgroundColor: colors.warm.surface, borderWidth: 1, borderColor: colors.warm.border, borderRadius: 12, paddingHorizontal: spacing[4], paddingVertical: spacing[3], marginBottom: spacing[3] },
...
const styles = StyleSheet.create({
  flex: { flex: 1 },
  navRow: { flexDirection: 'row', alignItems: 'center', paddingTop: spacing[2], paddingBottom: spacing[4] },
  navTitle: { flex: 1, textAlign: 'center', fontSize: 17, fontWeight: '600', color: colors.warm.title },
  navSpacer: { width: 40 },
  liveBanner: { flexDirection: 'row', alignItems: 'center', gap: spacing[2], backgroundColor: 'rgba(68, 0, 7, 0.06)', borderRadius: 8, paddingHorizontal: spacing[3], paddingVertical: spacing[2], marginBottom: spacing[4] },
  liveBannerText: { fontSize: 12, color: colors.burgundy.mid, fontWeight: '600' },
  scroll: { paddingBottom: spacing[4] },
  section: { marginBottom: spacing[5] },
  fieldLabel: { fontSize: 10, fontWeight: '700', letterSpacing: 1.2, textTransform: 'uppercase', color: colors.warm.muted, marginBottom: spacing[2] },
  typeGrid: { flexDirection: 'row', gap: spacing[2] },
  typeCard: { flex: 1, alignItems: 'center', padding: spacing[3], borderRadius: 12, borderWidth: 2, borderColor: colors.warm.border, backgroundColor: colors.warm.surface, gap: spacing[1] },
  typeCardActive: { borderColor: colors.burgundy.mid, backgroundColor: 'rgba(68, 0, 7, 0.05)' },
  typeIcon: { marginBottom: spacing[1] },
  typeLabel: { fontSize: 11, fontWeight: '700', color: colors.warm.title, textAlign: 'center', lineHeight: 14 },
  typeLabelActive: { color: colors.burgundy.mid },
  typeDesc: { fontSize: 9, color: colors.warm.muted, textAlign: 'center', lineHeight: 12, marginTop: 2 },
  imageContainer: { position: 'relative', borderRadius: 12, overflow: 'hidden', height: 176 },
  imagePreview: { width: '100%', height: '100%' },
  removeImageBtn: { position: 'absolute', top: spacing[2], right: spacing[2], width: 28, height: 28, borderRadius: 14, backgroundColor: 'rgba(0,0,0,0.6)', alignItems: 'center', justifyContent: 'center' },
  imagePicker: { height: 144, borderRadius: 12, borderWidth: 2, borderStyle: 'dashed', borderColor: colors.warm.border, backgroundColor: colors.warm.surface, alignItems: 'center', justifyContent: 'center', gap: spacing[2] },
  ...
  visibilityHint: { fontSize: 12, color: colors.warm.muted, lineHeight: 18, marginBottom: spacing[4] },
  stickyBar: { paddingVertical: spacing[3], borderTopWidth: 1, borderTopColor: colors.warm.border, backgroundColor: colors.warm.elevated },
